<template>
     <div  class="card bg-white card--image-left" :class="{'card--shadow': attributes.dropShadow, 'card--image-left': attributes.style === 'list', 'card--image-top': attributes.style === 'card'}">
          ...
          <div class="card__content">
                ...
                <p class="card__text" v-html="product.excerpt.rendered" style="overflow: hidden;"></p>
